...
errorCode4, IsObstacle, DistanceVector_left, ObstacleHandle, SurfaceNormalVector = vrep.simxReadProximitySensor(clientID,leftsensor,vrep.simx_opmode_streaming)

errorCode5, IsObstacle, DistanceVector_front, ObstacleHandle, SurfaceNormalVector = vrep.simxReadProximitySensor(clientID,frontsensor,vrep.simx_opmode_streaming)

k=0
dist_opt = 1

while clientID!=-1:
    errorCode4, IsObstacle_left, left, ObstacleHandle_left, SurfaceNormalVector_left = vrep.simxReadProximitySensor(clientID, leftsensor ,vrep.simx_opmode_buffer)        
    errorCode5, IsObstacle_front, front, ObstacleHandle_front, SurfaceNormalVector_front = vrep.simxReadProximitySensor(clientID, frontsensor ,vrep.simx_opmode_buffer)        
